    ...
    <ol>
      <li>
        ...
        <div>
          ...
          безопасности персональных данных, предпринимаемые ИП НОмоконов Д.С.
          ИНН 031804055917 (далее — Оператор).
        </div>
        <ol>
          <li>
      ...
      <li>
        ...
        <ol>
          ...
          <li>
            ...
            сети интернет по сетевому адресу https://ТолчокВперед.рф.
          </li>
          <li>
          ...
          <li>
            Пользователь — любой посетитель веб-сайта https://ТолчокВперед.рф.
          </li>
          <li>
      ...
      <li>
        <span>Основные права и обязанности Оператора</span>
        <ol>
          <li>
          ...
          <li>
            Оператор обязан: — предоставлять субъекту персональных данных по его
      ...
      <li>
        <span>Основные права и обязанности субъектов персональных данных</span>
        <ol>
          <li>
            Субъекты персональных данных имеют право: — получать информацию,
      ...
      <li>
        <span>Принципы обработки персональных данных</span>
        <ol>
          <li>
      ...
      <li>
        ...
        <ol>
          ...
          <li>
            ...
            уведомление на адрес электронной почты Оператора NOMOKONOVDS@MAIL.RU
          ...
          <li>
            ...
            NOMOKONOVDS@MAIL.RU с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
          <li>
      ...
      <li>
        ...
        <ol>
          <li>
            ...
            к Оператору с помощью электронной почты NOMOKONOVDS@MAIL.RU.
          </li>
          <li>
          ...
          <li>
            ...
            Интернет по адресу https://ТолчокВперед.рф.
          </li>
        </ol>
      </li>
    </ol>
